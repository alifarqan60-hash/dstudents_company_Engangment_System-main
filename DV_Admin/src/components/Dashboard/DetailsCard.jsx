...
export default function DetailsCard({ icon, label, value, loading, onClick }) {
  ...
  return (
    <>
      <div
        onClick={onClick}
        className="flex flex-1 px-5 mr-5 backdrop-blur-sm opacity-90 flex-col h-[150px] bg-blue-50 md:bg-customWhite55 rounded-2xl  border-[1.5px]  border-customDetailCardBorderColor shadow-customDetailCardShadow cursor-pointer"
      >
        {loading ? (
