...
import { deleteLesson } from "../../../../api/Course/deleteLesson";
import { useNavigate } from "react-router-dom";
// import { deleteUser } from "../../../api/Users/deleteUser";

export default function UserDeletedPopup({ user, cid, toggleFunc }) {
  ...
  const handleDeleteClick = async () => {
    ...
    try {
      await deleteLesson(cid, user.id);
      console.log("user deleted, CLG in delete function");
