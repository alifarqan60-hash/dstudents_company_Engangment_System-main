...
export default function AddUser({ toggleFunc, toggleAddedPopup, addedPopup }) {
    ...
    <div className="h-screen overflow-y-auto register-scrollbar2 rounded-l-3xl bg-customNewStudentCardColor absolute flex justify-end right-0 font-sans ">
      ...
      <div className=" w-[400px]  items-center">
        ...
        <div className="flex flex-1 justify-center mb-6">
          <p className=" mt-6 font-medium text-2xl">New User</p>
        </div>
          ...
          <div className="mb-4 ">
            ...
            <div className="flex flex-row border border-gray-300 rounded-md shadow-md focus-within:outline-none focus-within:border-blue-400 focus-within:ring-1 focus-within:ring-blue-500">
              <PhoneInput
                ...
                className={`w-full  text-sm outline-none bg-white rounded-l-lg rounded-r-lg ${
