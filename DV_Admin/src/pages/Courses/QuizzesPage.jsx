...
import UserAddedPopup from "../../components/Admin/Courses/Quizzes/UserAddedPopup";
import UserDeletedPopup from "../../components/Admin/Courses/Quizzes/UserDeletedPopup";
import UserEditedPopup from "../../components/Admin/Courses/Quizzes/UserEditedPopup";
import Loader from "../../components/Loader/Loader";
import UserDetailsCard from "../../components/Admin/Courses/Quizzes/UserDetailsCard";
import AddUser from "../../components/Admin/Courses/Quizzes/AddUser";
...
export default function QuizzesPage() {
  ...
  useEffect(() => {
    if (lectures) {
      const allQuizzes = lectures.map((lecture) => lecture.quiz).flat();
      console.log("All Quizzes: ", allQuizzes);
      setQuizes(allQuizzes);
    } else {
      console.log("No lectures available");
    }
  }, [lectures]);
  ...
  return (
    <>
      ...
      >
        {/* Header  */}
        <Header
          selectedPage={quizSelectedPage}
          handlePageToggle={setQuizSelectedPage}
