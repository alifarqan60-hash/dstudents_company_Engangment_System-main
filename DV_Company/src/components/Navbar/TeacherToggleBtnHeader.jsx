...
export default function TeacherHeader({ selectedPage, handlePageToggle }) {
  ...
  useEffect(() => {
    if (selectedPage === "Profile") {
      navigate(`/admin/teachers/view-teacher-profile`);
    } else {
      ...
      <div className="flex-[2]">
        <div className=" bg-customTogglePageBgColor w-64 ml-5 border rounded-full text-customDarkBlue text-sm">
          ...
          <button
            ...
            className={`py-2 px-4 w-1/2 rounded-full 
              ${selectedPage === "Profile" ? "bg-customYellow text-white" : ""}
          `}
          >
            Profile
          </button>
