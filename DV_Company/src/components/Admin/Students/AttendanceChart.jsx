    ...
    data: [
      {
        ...
        dataPoints: [
          { y: 80, label: "Present", color: "#63ABFD" }, // Change color of "Present"
    ...
    >
      <div
        style={{
          ...
          position: "absolute",
          zIndex: 10,
          top: "30px", // Adjust this value as needed to position below the title
        }}
      >
        <span style={{ color: "#63ABFD" }}>{presentCount}</span>
