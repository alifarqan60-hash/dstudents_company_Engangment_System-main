...
export default function ParentPage() {
  ...
  const [deletedParentName, setDeletedParentName] = useState("");
    ...
    <>
      ...
      >
        <div className=" flex-[5] w-full ">
          {/* NavBar  */}
          <Navbar heading={"Parents"} name={"Alex Jhons"} role={"Admin"} />
              ...
              <div>
                {currentParents.map((parent) => (
                  <ParentDetailsCard
                    ...
                    reg_children={parent.reg_children}
